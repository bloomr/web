feature "Enrolling" do
  ...
  scenario "I can enroll" do
    ...
    fill_in "Quels sont les 5 mots clés qui vous viennent spontanément à l’esprit quand vous pensez à votre métier ?", :with => "1, 2, 3, 4, 5"
    ...
    expect(loulou.questions[0].answer).to eq("je plante des pommiers")
    expect(loulou.questions[1].answer).to eq("j aime les arbres")
